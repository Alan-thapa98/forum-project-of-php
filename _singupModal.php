    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="singupModalLabel"> Sing up for iDiscuss account</h5>
                ...
                <form action="/forum/partials/_handlesingup.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            id="singupEmail" name="singupEmail">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Confrom
                            Password</label>
